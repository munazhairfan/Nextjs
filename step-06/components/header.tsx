...
const header = () => {
  return (
    <>
    <div className='w-[1280px] h-[54px] bg-[#f7f7f7] px-16 items-center hidden xl:flex  border-b-[1px] border-black'>
      <div className='w-[1154px] h-[54px] py-3 flex gap-8'>
      ...
      <div className='w-[736px] h-6 flex gap-4'>
        <div className='w-[132px] h-6 flex gap-3 ml-auto'>
    ...
    <div className='w-[428px] h-[72px] border-b-[1px] p-4 border-[#848484] place-items-center
     xl:bg-[#f7f7f7] xl:w-[1280px] xl:mt-3'>
        <div className='gap-6 flex'>
            <div className='w-[300px] xl:w-[200px]'>
                <Image src={'/images/logo.png'} alt='logo' width={130.6} height={40}></Image>
            </div>
            <div className='hidden xl:w-[910px] xl:h-11 xl:flex xl:gap-8 xl:bg-white items-center'>
              <div className='w-[687px] h-11 flex gap-8 items-center justify-center'>
            ...
            <div className='w-12 h-12 xl:hidden'><Image src={'/images/vector5.png'} alt='bars' width={48} height={48}></Image></div>
        </div>
    </div>
    </>
  )
