...
const footer = () => {
  return (
    <>
    {/* footer */}
    <div className='w-[428px] h-[1411px] flex flex-col px-6 py-12 items-center'>
      <div className='w-[380px] h-[1315px] flex flex-col gap-12 items-center'>
        {/* footer 1 */}
        <div className="w-[380px] h-[261px] flex flex-col gap-6 place-items-center">
          <div className='w-[287px] h-[91px] flex flex-col gap-4'>
            <p className='font-semibold text-[16px] leading-[27px] text-center'>Subscribe to our newsletter</p>
            <p className='text-[16px] leading-6 text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </div>
          <div className='w-[380px] h-[146px] flex flex-col gap-4'>
            ...
            <p className='text-[12px] leading-[18px] text-center'>By subscribing you agree to with our Privacy Policy</p>
          </div>
        </div>
        {/* footer 2 */}
        <div className="w-[172px] h-[811px] flex flex-col gap-8 items-center">
          <div><Image src={'/images/logo.png'} alt='logo' width={130.6} height={40}></Image></div>
          <div>
            <ul className='w-[172px] h-[225px] flex flex-col gap-4 text-[14px] text-center leading-[18px]'>
        ...
        <div className="w-[380px] h-[130px] flex flex-col gap-6 border-t-[1px] border-black place-items-center">
            <div className='w-[345px] h-[66px] flex flex-col gap-6 place-items-center mt-6'>
            ...
            <div className='w-[132px] h-6 flex gap-3 '>
