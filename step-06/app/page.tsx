...
const page = () => {
  return (
    ...
    <div className='flex flex-col w-full xl:flex-row xl:h-[800px] items-center justify-around'>
        <div className='w-full h-[390px] xl:w-[852px] flex flex-col gap-8 items-center justify-center p-6'>
          <div className='flex flex-col gap-6'>
            <div className='w-[320px] lg:w-[400px] h-[96px]'>
            <h1 className='font-bold text-[40px] leading-[48px] lg:text-[50px]'>Learn new skills online with ease</h1>
            </div>
            <div className='w-[320px] lg:w-[380px] h-[54px] lg:text-[20px]'>
            ...
            <div className='w-[320px] lg:w-[380px] h-16 flex flex-row gap-4 items-end'>
    ...
    xl:flex-row xl:bg-[#f7f7f7] place-items-center justify-around'>
      ...
      <div className='flex xl:gap-[19] lg:w-[480px] justify-around xl:w-[990px]'>
    ...
    <div className='flex flex-col w-full h-[862px] gap-12 px-6 py-12'>
      ...
      <div className='flex flex-col w-full h-[556px] gap-24 xl:gap-12 xl:h-[700px] items-center'>
        {/* category one */}
        <div className='flex flex-col gap-6 w-[320px] h-[444px] 
        xl:flex-row xl:h-[132px] xl:w-full xl:justify-center lg:w-[380px]'>
        <div className='flex lg:w-[380px] w-[320px] gap-8 items-center h-[132px] rounded-[5px] p-4 bg-[#f7f7f7]'>
    ...
    xl:h-[1600px] lg:h-[1000px]'>
      ...
      <div className='w-full h-[1898px] flex flex-col gap-16 xl:h-[1340px] lg:h-[800px]'>
        ...
        <div className='flex flex-col w-full h-[1690px] gap-20 xl:h-[1132px] lg:h-[650px]'>
          ...
          {/* course 1 */}
          <div className='bg-[#f7f7f7] rounded-[5px] lg:w-[380px] w-[320px] h-[558px]'>
            <div><Image src={'/images/course1.png'} alt='course1' width={380} height={300}></Image></div>
            <div className='lg:w-[380px] w-[320px] h-[234px] flex flex-col gap-2 place-items-center justify-center'>
              <div className='lg:w-[348px] w-[288px] h-[146px] flex flex-col gap-2'>
                <div className='flex'>
              ...
              <div className='flex gap-12 items-center lg:w-[348px] w-[288px] h-10'>
    ...
    xl:h-[830px] xl:bg-[#f7f7f7] xl:px-16 xl:py-28'>
      ...
      <div className='w-[320px] h-[417.89px] flex flex-col gap-12 xl:w-[1152px] xl:h-[417.89px] lg:w-full lg:place-items-center'>
        <div className='flex xl:w-[1152px] xl:h-[321.89px] xl:gap-8 lg:justify-center'>
        {/* customer 1 */}
        <div className='w-[320px] lg:w-[380px] h-[321.89px] flex flex-col gap-8 border-[2px] border-black p-5'>
          {/* stars */}
        ...
        {/* arrows */}
        <div className='flex w-[320px] lg:w-[380px] h-12 justify-between items-center xl:w-[1152px]'>
