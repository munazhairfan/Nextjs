...
const page = () => {
  return (
    <>
    {/* hero div */}
    <div className='flex flex-col xl:flex-row xl:w-[1280px] xl:h-[800px] xl:items-center'>
    ...
    {/* companies */}
    <div className='flex flex-col w-[428px] h-[239.34px] gap-6 px-6 py-12 xl:flex-row xl:w-[1280px] xl:bg-[#f7f7f7] xl:place-items-center'>
      <div className='w-[327px] h-[54px]'>
        <p className='font-bold leading-[27px] text-[18px]'>Trusted by the world's best companies [social proof to build credibility]</p>
      </div>
      <div className='flex gap-[19] w-[880px] xl:justify-between'>
        ...
        <div ><Image src={'/images/c4.png'} width={120} height={35} alt='companyname4'></Image></div>
        <div ><Image src={'/images/c5.png'} width={120} height={35} alt='companyname5'></Image></div>
        <div ><Image src={'/images/c6.png'} width={120} height={35} alt='companyname6'></Image></div>
      </div>
    </div>
    {/* categories */}
    <div className='flex flex-col w-[428px] h-[862px] gap-12 px-6 py-12'>
      {/* div 1 */}
      <div className='flex flex-col gap-6 w-[385px] h-[162px] xl:w-[1280px] xl:h-[109px]'>
      ...
      {/* div 2 */}
      <div className='flex flex-col w-[380px] h-[556px] gap-24 xl:gap-12 xl:h-[700px] xl:w-[1280px]'>
        {/* category one */}
        <div className='flex flex-col gap-6 w-[380px] h-[444px] xl:flex-row xl:h-[132px] xl:w-[1280px] xl:justify-center'>
    ...
    {/* achievements */}
    <div className='flex flex-col w-[428px] h-[451px] gap-12 px-6 py-12 place-content-center 
    xl:w-[1280px] xl:h-[488px]'>
      <div className='flex flex-col gap-6 w-[380px] h-[355px] xl:w-[1152px] xl:h-[264px]'>
        <div className='flex flex-col gap-4'>
          <p className='w-[380px] h-[42px] leading-[41.6px] text-[32px] font-bold text-center xl:text-[40px]'>Our Achivements</p>
          <p className='w-[362px] h-[81px] xl:w-[1152px] text-[18px] leading-[27px] text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. 
        ...
        <div className='w-[380px] h-[176px] flex flex-col gap-6 xl:w-[1152px] xl:h-[96px] xl:flex-row'>
          <div className='w-[380px] h-[76px] flex gap-4 py-2'>
    ...
    {/* courses */}
    <div className='w-[428px] h-[2135px] flex flex-col gap-10 px-6 py-8 justify-between'>
      {/* div 1 */}
      <div className=' h-[93px] flex flex-col gap-4 place-items-center justify-between'>
        <p className='font-bold text-[32px] leading-[41.6px] text-center'>Courses</p>
        <p className='text-center leading-[27px] text-[18px]'>Your Ultimate Guide to learning</p>
      </div>
      {/* div 2 */}
      <div className='w-[380px] h-[1898px] flex flex-col gap-16'>
        ...
        <div className='flex flex-col w-[380px] h-[1690px] gap-16'>
          {/* course 1 */}
          <div className='bg-[#f7f7f7] rounded-[5px]'>
    ...
    {/* team */}
    <div className='w-[428px] h-[1150px] flex flex-col gap-12 px-4 py-12 bg-[#f7f7f7] place-items-center justify-between'>
      ...
      <div className='w-[380px] h-[723px] flex flex-col gap-16'>
        {/* team 1 */}
    ...
    {/* Review */}
    <div className='w-[428px] h-[681.89px] flex flex-col gap-12 px-6 py-12'>
      <div className='w-[361px] h-[120px] flex flex-col gap-6'>
        <p className='font-bold text-[32px] leading-[41.6px] text-center'>What Our Student Say</p>
        <p className='text-[18px] leading-[27px] text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
      </div>
        ...
        <div className='w-[380px] h-[321.89px] flex flex-col gap-8 border-[2px] border-black p-5'>
          ...
          <div className='w-[316px] h-[215px] flex flex-col gap-6'>
            ...
            <div className='flex gap-4'>
              <Image src={'/images/team3.png'} alt='studentpfp' width={54} height={54} className='rounded-full bg-center'></Image>
            <div><p className='font-semibold text-[16px] leading-6'>Wade Warren</p>
            <p>Position, Company name</p></div>
            </div>
          </div>
        </div>
        {/* arrows */}
        <div className='flex w-[380px] h-12 justify-between items-center'>
